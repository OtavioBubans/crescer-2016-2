class TelaPrincipal {
  ...
  registrarBindsEventos(self) {
    ...
    self.$btnAnteriorPagina.on('click', self.sincronizar.bind(self));
    self.$btnAteriorPagina = $();
  }
  ...
  sincronizar() {
    let self = this;
    let url = 'https://gateway.marvel.com:443/v1/public/characters?apikey=ea4647ccc6693d71a744497026b02ee9&orderBy=-modified&limit=20';
    $.get(url).then((res) => {
